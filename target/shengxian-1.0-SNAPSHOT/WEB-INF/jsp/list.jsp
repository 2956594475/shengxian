        ...
        <div class="new_goods">
            ...
            <ul>
                <c:forEach items="${new_sku}" var="sku">
                    <li>
                        <a href="${pageContext.request.contextPath}/goods/${sku.id}"><img src="${pageContext.request.contextPath}/${sku.image}"></a>
            ...
            <c:forEach items="${skus}" var="sku">
                <li>
                    <a href="${pageContext.request.contextPath}/goods/${sku.id}">
                        <img src="${pageContext.request.contextPath}/${sku.image}">
                    </a>
